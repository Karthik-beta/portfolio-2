...
import primeng from "../../assets/images/primeng.svg";
  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt="tech"
        id="aws-img"
        className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24 lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:top-[460px] 2xl:left-[440px] 1xl:top-[400px] 1xl:left-[380px] 1/2xl:top-[400px] 1/2xl:left-[380px] xl:top-[420px] xl:left-[380px] lg:top-[360px] lg:left-[360px] md:top-[340px] md:left-[270px] sm:top-[440px] sm:left-[140px] vvs:top-[440px] vvs:left-[80px] top-[490px] left-[80px] opacity-1 rotate-[-10deg]"
      />
      {/* <img
        src={js}
        alt="tech"
      ...
      {/* <img
        ...
        alt="tech"
        id="docker-img"
        className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24 lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:right-[880px] 2xl:bottom-[970px] 1xl:right-[690px] 1xl:bottom-[870px] 1/2xl:right-[680px] 1/2xl:bottom-[970px] xl:right-[680px] xl:bottom-[970px] lg:right-[480px] lg:bottom-[880px] md:right-[340px] md:bottom-[840px] sm:right-[340px] sm:bottom-[840px] vvs:right-[100px] vvs:bottom-[750px] right-[100px] bottom-[760px] opacity-1 rotate-[-50deg]"
      /> */}
      <img
        src={docker}
        alt="tech"
        id="docker-img"
        className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24 lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:right-[880px] 2xl:bottom-[870px] 1xl:right-[690px] 1xl:bottom-[770px] 1/2xl:right-[680px] 1/2xl:bottom-[870px] xl:right-[680px] xl:bottom-[870px] lg:right-[480px] lg:bottom-[780px] md:right-[340px] md:bottom-[740px] sm:right-[340px] sm:bottom-[740px] vvs:right-[100px] vvs:bottom-[690px] right-[100px] bottom-[700px] opacity-1 rotate-[-50deg]"
      />
      <img
        src={primeng}
        alt="tech"
      ...
      <img
        ...
        alt="tech"
        id="sass-img"
        className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24  lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:left-[280px] 2xl:bottom-[440px] 1xl:left-[290px] 1xl:bottom-[380px] 1/2xl:left-[280px] 1/2xl:bottom-[350px] xl:left-[280px] xl:bottom-[380px] lg:left-[280px] lg:bottom-[320px] md:left-[240px] md:bottom-[320px] sm:left-[140px] sm:bottom-[320px] vvs:left-[40px] vvs:bottom-[300px] left-[40px] bottom-[300px] opacity-1 rotate-135"
      />
      <img
        src={node}
        alt="tech"
        id="node-img"
        className="tech 2xl:h-28 2xl:w-28 xl:h-24 xl:w-24  lg:h-20 lg:w-20 md:h-20 md:w-20 sm:h-16 sm:w-16 vvs:h-14 vvs:w-14 w-12 h-12 absolute 2xl:right-[380px] 2xl:top-[500px] 1xl:right-[390px] 1xl:top-[500px] 1/2xl:right-[380px] 1/2xl:top-[550px] xl:right-[380px] xl:top-[550px] lg:right-[320px] lg:top-[500px] md:right-[220px] md:top-[550px] sm:right-[250px] sm:top-[550px] vvs:right-[50px] vvs:top-[550px] right-[50px] top-[500px] opacity-1 rotate-[-300deg]"
      />
      {/* <img
        src={mongo}
        alt="tech"
