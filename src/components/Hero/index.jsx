...
import profilePhoto from "../../assets/images/karthik.png";
            ...
            >
              <div>
                <img
                  ...
                  id="profilePhoto"
                  className="rounded-full !z-10 lg:h-20 lg:w-20 md:h-16 md:w-16 vvs:h-14 vvs:w-14 w-12 h-12 hover:scale-[1.2] hover:shadow-custom1 hover:-rotate-12 transition-all duration-300 ease-in-out cursor-pointer relative top-[-5px]"
                />
              </div>
            </Tooltip>
          </div>
          ...
          >
            <div className="w-full flex md:flex-row flex-col justify-between items-center ">
              <div>
                ...
                As a full-stack web developer, my expertise encompasses the end-to-end development of enterprise applications. I excel in crafting seamless and intuitive user experiences by leveraging 
                cutting-edge technologies. My proficiency extends to Angular and Django, where I harness the power of these frameworks to build robust, dynamic, and sophisticated web applications. 
                With a strong foundation in both frontend and backend technologies, I am dedicated to delivering high-quality solutions that meet the complex requirements of enterprise-level projects.
                </p>
              </div>
